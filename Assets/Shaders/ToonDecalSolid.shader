Shader "Custom/ToonDecal"
{
    ...
    SubShader
    {
        // Decals use the "Decal" RenderType and Queue
        Tags { "RenderType"="Transparent" "Queue"="Transparent+1" "Decal"="True" }

        Pass
        {
            // Decals use the "UniversalForward" or "UniversalGBuffer" depending on pipeline
            ...
            float4 frag(Varyings IN) : SV_Target
            {
                ...
                // Decals should respect alpha blending
